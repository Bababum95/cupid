...
export const PAYMENT_METHODS = [
  ...
  { src: "/images/payments/gpay.png", alt: "Google Pay", name: "gpay" },
  { src: "/images/payments/applepay.png", alt: "Apple Pay", name: "applepay" },
  { src: "/images/payments/unionpay.png", alt: "UnionPay", name: "unionpay" },
  {
  ...
  { src: "/images/payments/shoppay.png", alt: "Shoppay", name: "shoppay" },
